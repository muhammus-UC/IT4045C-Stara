...
class ScheduleDataUnitTest {
    ...
    void confirmScheduledCBSEpisode_outputsScheduledCBSEpisode() {
        ...
        scheduleFeedItem.getShow().setImage(new ImageURLs("http://static.tvmaze.com/uploads/images/medium_portrait/237/592585.jpg"));
        ...
        assertEquals(new ImageURLs("http://static.tvmaze.com/uploads/images/medium_portrait/237/592585.jpg"), scheduleFeedItem.getShow().getImage());
        ...
        String stringEpisode44 = "ScheduleFeedItem - Episode: Episode 44. Airtime: 09:00. URL: http://www.tvmaze.com/episodes/1954168/cbs-news-sunday-morning-2020-11-01-episode-44. " +
                "Show: Show Info - ID: 15779. URL: http://www.tvmaze.com/shows/15779/cbs-news-sunday-morning. Name: CBS News Sunday Morning. Language: English. Status: Running. Image URL: ImageURLs(medium=http://static.tvmaze.com/uploads/images/medium_portrait/237/592585.jpg)";
    ...
    void confirmScheduledGirlMeetsFarmEpisode_outputsScheduledGirlMeetsFarmEpisode() {
        ...
        scheduleFeedItem.getShow().setLanguage("English");
        scheduleFeedItem.getShow().setStatus("Running");
        scheduleFeedItem.getShow().setImage(new ImageURLs("http://static.tvmaze.com/uploads/images/medium_portrait/158/396187.jpg"));
        ...
        assertEquals("English", scheduleFeedItem.getShow().getLanguage());
        assertEquals("Status: Running", scheduleFeedItem.getShow().getStatus());
        assertEquals(new ImageURLs("http://static.tvmaze.com/uploads/images/medium_portrait/158/396187.jpg"), scheduleFeedItem.getShow().getImage());
        ...
        String stringEpisodeDinner = "ScheduleFeedItem - Episode: Dinner Staycation. Airtime: 11:00. URL: http://www.tvmaze.com/episodes/1953551/girl-meets-farm-6x10-dinner-staycation. " +
                "Show: Show Info - ID: 36765. URL: http://www.tvmaze.com/shows/36765/girl-meets-farm. Name: Girl Meets Farm. Language: English. Status: Running. Image URL: ImageURLs(medium=http://static.tvmaze.com/uploads/images/medium_portrait/158/396187.jpg)";
    ...
    private void givenScheduleDataAreAvailable() throws IOException {
        ...
        scheduleFeedItem1.getShow().setImage(new ImageURLs("http://static.tvmaze.com/uploads/images/medium_portrait/237/592585.jpg"));
        ...
        scheduleFeedItem2.getShow().setImage(new ImageURLs("http://static.tvmaze.com/uploads/images/medium_portrait/158/396187.jpg"));
